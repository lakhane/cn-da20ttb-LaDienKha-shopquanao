...
namespace ShopOnline.Areas.Admin.Controllers
{
    ...
    public class CRUDmemberController : Controller
    {
        ...
        public ActionResult Create(Member member, HttpPostedFileBase uploadFile)
        {
            try
            {
                ...
                if (extension.ToLower() == ".jpg" || extension.ToLower() == ".jpeg" || extension.ToLower() == ".png")
                {
                    if (check != null)
                    {
                        ModelState.AddModelError("", "Tên đã có người dùng");
                    }
                    else
                    {
                        if (uploadFile == null)
                        ...
                        else
                        {
                            ...
                            if (db.SaveChanges() > 0)
                            {
                                ...
                                ModelState.Clear();
                                TempData["msgCreate"] = "Tạo thành viên mới thành công!";
        ...
        public ActionResult Edit(Member member, HttpPostedFileBase uploadFile)
        {
            ...
            {
                TempData["msgEditFailed"] = "Tạo không thành công! " + ex.Message;
                return RedirectToAction("Index");
            }
        }
        ...
        public ActionResult Delete(string userName)
        {
            try
            {
                ...
                {
                    TempData["msgDeleteFailed"] = "Không thể xóa cái này! ";
                    return RedirectToAction("Index");
                }
                else
                {
