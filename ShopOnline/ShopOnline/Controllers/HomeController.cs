...
namespace shopOnline.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Contact(Contact contact)
        {
            ...
            if (result > 0)
            {
                ViewBag.MessageSuccess = "Tin nhắn của bạn đã được chúng tôi nhận được. Chúng tôi sẽ liên hệ với bạn ngay khi có thể.";
            }
            return View(contact);
        }
        ...
        public ActionResult EditProfie(Member member, HttpPostedFileBase uploadFile)
        {
            ...
            {
                TempData["msgEditProfieFailed"] = "Chỉnh sửa không thành công! " + ex.Message;
                return RedirectToAction("Index");
            }
        }    
        [HttpGet]
        ...
        public ActionResult ChangePassword(Member member, FormCollection collection)
        {
            try
            {
                ...
                {
                    ModelState.AddModelError("", "Mật khẩu của bạn không chính xác!");
                    return View(member);
                }
            }
            catch (Exception ex)
            {
                TempData["msgChangePasswordFailed"] = "Chỉnh sửa không thành công! " + ex.Message;
                return RedirectToAction("Index");
            }
        }
        [HttpGet]
        ...
        public ActionResult Delete(string id)
        {
            ...
            TempData["msgDeleteOrder"] = "Xóa đơn hàng thành công!";
            db.SaveChanges();
            return RedirectToAction("Index");
        }
